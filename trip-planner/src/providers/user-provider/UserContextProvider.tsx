...
const UserContextProvider = ({ children }: any) => {
    ...
    const changeUserInformationToLoggedIn = useCallback((newAccessToken: string, newRefreshToken: string, userId: string) => {
    ...
    }), [isAuthenticated, role, hasNotifications, id, changeUserInformationToLoggedIn, changeUserInformationToLoggedOut, changeHasNotifications]);
