    ...
    <Card className="budget-card">
      <CardContent className="budget-card-content">
        <div className="flex flex-col">
          ...
          <p className="mt-1 text-lg">{getTypeName()}</p>
          {budget.description && (
            <p className="mt-2 description-text">{budget.description}</p>
          )}
        </div>
        <div className="mt-2">
          <p className="mt-2 mb-4 text-lg flex flex-col justify-end">
            {budget.unlimitedBudget ? (
              <>
                <p>Budget is unlimited.</p>
                <span>
                  {budget.spentAmount.toFixed(2)} {budget.mainCurrency} Spent.{" "}
                </span>
              ...
              <>
                <span>
                  ...
                  {budget.mainCurrency} Spent
                </span>
                <Progress
                  value={getSpentAmountPercentage()}
